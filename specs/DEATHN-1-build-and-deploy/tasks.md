...
- [X] T025 [US3] Commit and push T023+T024. Confirm the workflow shows up in the Actions tab. If T019's manual publish was skipped, this push is the first publish — verify the URL goes live within 10 minutes (SC-005) and that gameplay matches the local US2 verification. **[Done: workflow committed and pushed to branch; URL goes live when PR is merged to main]**
