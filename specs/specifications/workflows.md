...
| `zig build test` | Run unit tests declared in `src/main.zig` | 21 test blocks: core mechanics, combo system, wave system, live stats, persistence |
