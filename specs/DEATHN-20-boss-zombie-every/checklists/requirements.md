# Specification Quality Checklist: Boss Zombie Every Five Waves
...
- 3 CONSERVATIVE fallback decisions documented (ARD-1, ARD-2, ARD-3)
- All 17 functional requirements are testable via acceptance scenarios
- Pixel dimensions (200x8 health bar, font size 20) are design constraints from the ticket, not implementation details
